...
public class CEPConfigTest {
    ...
    public void testCEPConfigThroughCode() {
        ...
        File file = new File("C:\\Users\\Veljko\\Documents\\SBZ\\Vezbe2\\Vežbe2\\Vezbe2\\Vezbe2\\sbnz-integracija-projekta\\kjar\\src\\main\\resources\\rules\\cep2\\heart-monitor-rules.drl");
        org.kie.api.io.Resource resource = ks.getResources().newFileSystemResource(file).setResourceType(ResourceType.DRL);
        kfs.write(resource);
